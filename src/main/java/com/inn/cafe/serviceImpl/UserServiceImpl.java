...
import com.inn.cafe.JWT.UserDetailsService;
...
public class UserServiceImpl implements UserService {
    ...
    public ResponseEntity<String> login(Map<String, String> requestMap) {
        ...
        try {
            ...
            if(auth.isAuthenticated()){
                if(userDetailsService.getUserDetail().getStatus().equalsIgnoreCase("true")){
                    return new ResponseEntity<String>("{\"token\":\"" +
                            jwtUtil.generateToken(userDetailsService.getUserDetail().getEmail(), userDetailsService.getUserDetail().getRole()) + "\"}",
                    HttpStatus.OK);
                }
                else{
            ...
            log.error("{}", ex);
           // return new ResponseEntity<String>("{\"error\":\""+"Bad Credentials."+"\"}", HttpStatus.BAD_REQUEST);
        }
        return new ResponseEntity<String>("{\"error\":\""+"Bad Credentials."+"\"}", HttpStatus.BAD_REQUEST);
    }
